...
class AuthController
{
    ...
    public function login(Request $request, Response $response): Response
    {
        ...
        if (!$this->authService->verifyPassword($password, $user['password_hash'])) {
            ...
            User::incrementLoginAttemptsById($user['id']);

            // Lock account after 5 failed attempts
            if (($user['login_attempts'] + 1) >= 5) {
                User::lockAccountById($user['id'], 30); // Lock for 30 minutes
            }
        ...
        User::resetLoginAttemptsById($user['id']);
        User::updateLastLoginById($user['id']);
    ...
    public function me(Request $request, Response $response): Response
    {
        ...
        $safeUser = User::getSafeUser($user);
    ...
    public function updateProfile(Request $request, Response $response): Response
    {
        ...
        $success = User::updateById($userId, $updateData);
    ...
    public function verifyEmail(Request $request, Response $response, array $args): Response
    {
        ...
        $success = User::verifyEmailById($user['id']);
    ...
    public function resetPassword(Request $request, Response $response): Response
    {
        ...
        $success = User::updateById($user['id'], [
            'password_hash' => $passwordHash,
