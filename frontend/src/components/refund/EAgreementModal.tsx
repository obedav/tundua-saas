        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-green-600 dark:text-green-400">NGN ₦{refundAmount.toLocaleString('en-NG')}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="border border-gray-300 dark:border-gray-600 rounded-lg p-4 max-h-60 overflow-y-auto">
            <h3 className="font-semibold dark:text-white mb-3">Terms & Conditions</h3>
