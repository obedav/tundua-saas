...
export default function RefundCenter() {
  ...
  const getStatusBadge = (status: RefundRequest["status"]) => {
    const badges = {
      pending: { color: "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400", icon: Clock, text: "Pending Review" },
      processing: { color: "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400", icon: Clock, text: "Processing" },
    ...
    <div className="space-y-6">
      ...
      {showRequestForm && (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Request a Refund</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-lg font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">Your Refund Requests</h3>
        </div>

        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {refundRequests.length === 0 ? (
            <div className="p-12 text-center">
              <DollarSign className="h-12 w-12 text-gray-300 dark:text-gray-500 mx-auto mb-4" />
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <h4 className="font-semibold text-gray-900 dark:text-white">{request.application_reference}</h4>
                          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{request.reason}</p>
                        </div>
                        <p className="text-xl font-bold text-gray-900 dark:text-white">₦{request.amount.toLocaleString('en-NG')}</p>
                      </div>
