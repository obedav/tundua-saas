    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Partner Universities</h2>
        </div>
        <a
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-white">{university.acceptanceRate}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Tuition</p>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">{university.tuitionRange}</p>
                  </div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
        <div className="bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-lg p-4">
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Need Help Choosing?</h3>
