    ...
    <div className="space-y-4">
      ...
      >
        ...
        {isProcessing ? (
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-lg font-medium dark:text-white">Scanning passport...</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Processing image with OCR... (15-30 seconds)</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">Please wait, this takes a moment</p>
            </div>
          </div>
        ) : preview ? (
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Click to upload a different image</p>
          </div>
        ) : (
          <div className="flex flex-col items-center gap-3">
            <Upload className="h-12 w-12 text-gray-400 dark:text-gray-500" />
            <div>
              <p className="text-lg font-medium dark:text-white">Upload passport photo page</p>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-3 text-sm text-blue-800 dark:text-blue-300">
        ...
        <ul className="mt-2 ml-6 list-disc space-y-1 text-xs">
          <li><strong className="text-blue-900 dark:text-blue-200">Internet connection required</strong> (downloads 3MB OCR model on first use)</li>
          ...
          <li className="text-blue-900 dark:text-blue-200"><strong>No internet? Enter details manually below instead</strong></li>
        </ul>
      </div>
    </div>
  );
