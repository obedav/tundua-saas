  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:border-primary-300 hover:shadow-md transition-all">
      ...
      <div className="bg-gradient-to-r from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-lg p-6 border border-primary-200 dark:border-primary-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-1">University Resources</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Partner universities and programs</p>
            </div>
          ...
          >
            <div>
              <h4 className="font-medium text-gray-900 dark:text-white mb-1">Embassy Directory</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Visa offices and contacts</p>
            </div>
            <span className="text-primary-600 dark:text-primary-400">→</span>
          </a>
        </div>
