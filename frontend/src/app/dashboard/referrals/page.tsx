...
export default function ReferralsPage() {
  ...
  const shareViaWhatsApp = () => {
    const message = `I'm using Tundua to handle my study abroad application — no agents, no fraud risk, AI-powered and direct. Use my referral link and we both get ₦10,000 off: ${referralLink}`;
