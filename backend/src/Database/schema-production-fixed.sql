...
-- Version: 1.0 - FIXED for cPanel import
-- Date: 2025-01-06
...
-- ============================================================================
-- PAYMENTS (Moved before APPLICATIONS to fix foreign key dependency)
-- ============================================================================
...
-- Add foreign keys to payments table now that applications exists
